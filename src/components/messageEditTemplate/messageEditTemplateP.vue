        ...
        <div class="form-group form_edit">
            ...
            <div class="edit-box">
                ...
                <div class="textarea-box">
                    ...
                    <textarea id="msgEditContentP" style="text-indent: 4em" v-textarea-delete="msgContentData" v-model="msgContentData">
                    </textarea>
                </div>
                <div class="bottom">
...
export default {
    ...
    watch: {
        ...
        verificationData() {
            if (this.verificationData.hasOwnProperty('second_open')) {
                this.msgContent.open = this.verificationData.second_open
            }
            if (this.verificationData.hasOwnProperty('second_unpay_time')) {
                this.msgContent.unpay_time = this.verificationData.second_unpay_time
            }
            if (this.verificationData.hasOwnProperty('second_multi_order_pay')) {
                this.msgContent.multi_order_pay = this.verificationData.second_multi_order_pay
            }
            if (this.verificationData.hasOwnProperty('second_unmod_remind_pay')) {
                this.msgContent.unmod_remind_pay = this.verificationData.second_unmod_remind_pay
            }
            if (this.verificationData.hasOwnProperty('second_send_type')) {
                this.msgContent.send_type = this.verificationData.second_send_type
            }
        },
        msgState() {
            if (this.msgState.type == 'messageTemplateP') {
    ...
    methods: {
        ...
        insert(content) {
            content = '<' + content + '>';
            var val = content;
            var domElement = document.getElementById('msgEditContentP');
