<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :checkBuyAll="checkBuyAll" :marketingType="g_const.marketTemplateType.FMGGCARE_P4P_SYS" :updateSidebar="getMaintenanceSidebar">
      <template slot="baseConfig" scope="props">
        ...
        <lazy-render loadingTime="200">
          <div class="form-control form_control" style="padding-bottom: 0px">
            ...
            <config-sendtime-N :sendTimeLabel='props.conf.send_time_label' :sendTime='props.conf.send_time' :excludeTimeLabel='props.conf.exclude_time_label' :elcludeTime="props.conf.exclude_time" :sendTimeDay='props.conf.send_time_day' :sendWord="'提前'" :aheadTimeLabel="props.conf.ahead_time_label">
            </config-sendtime-N>
            <el-form-item>
...
import service from '../FMGGcare.service'
export default {
  data() {
    return {
      showMoreBlock: false,
