<template>
  <div class="sub_main_content">
    ...
    ref='reasonconfig'
    :service="service"
    :marketingType="g_const.marketTemplateType.EMAILEXCUSE_P4P_SYS"
    :updateSidebar="getSaveCustomerSidebar">
      ...
      scope="props">
          ...
          <div class="form-control">
            <config-sendtime-N :sendTimeLabel='props.conf.send_time_label' :sendTime='props.conf.send_time' :excludeTimeLabel='props.conf.exclude_time_label' :elcludeTime="props.conf.exclude_time"  :sendWord="'提前'" :sendTypeWord="'邮件不发送时间段'">
            </config-sendtime-N>
            <el-form-item>
...
<script type="text/ecmascript-6" scoped>
  ...
  import service from '../emailExcuse.service'
  export default {
    data() {
      return {
        showMoreBlock: false,
