<template>
  <div>
    <marketing-header base="基于【季节性新品】模板" tip="设计理念：喜新厌旧是人的本性，尤其当前的人的整体生活水平提高，对于新品的喜好更加突出，店铺实际有新品但碍于竞争或版面限制，无法有效传递给买家这是莫大的悲哀，通过此专用通道针对性的推送给需要的买家，既可以留住买家又可以推送新品增长，一箭双雕" remind='提醒：季节性新品主要用于季节性交替类，比如夏装换季上秋装了'>
    </marketing-header>
    <div>
