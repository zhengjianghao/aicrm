<template>
  <div>
    <marketing-header base="基于【同类型新品】模板" tip="设计理念：喜新厌旧是人的本性，尤其当前的人的整体生活水平提高，对于新品的喜好更加突出，店铺实际有新品但碍于竞争或版面限制，无法有效传递给买家这是莫大的悲哀，通过此专用通道针对性的推送给需要的买家，既可以留住买家又可以推送新品增长，一箭双雕" remind='提醒：同类型产品指相同属性的，比如同为T恤'>
    </marketing-header>
    <div>
