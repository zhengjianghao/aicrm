<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :checkBuyAll="checkBuyAll" :marketingType="g_const.marketTemplateType.UPDATANEW_P4P_SYS" :updateSidebar="getSaveCustomerSidebar">
...
import service from '../updataNew.service'
