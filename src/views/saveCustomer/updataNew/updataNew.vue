<template>
  <div>
    <marketing-header base="基于【换代型新品】模板" tip="设计理念：喜新厌旧是人的本性，尤其当前的人的整体生活水平提高，对于新品的喜好更加突出，店铺实际有新品但碍于竞争或版面限制，无法有效传递给买家这是莫大的悲哀，通过此专用通道针对性的推送给需要的买家，既可以留住买家又可以推送新品增长，一箭双雕" remind='提醒：换代型主要用于产品升级换代，比如IP6升级换代到IP7'>
    </marketing-header>
    <div>
