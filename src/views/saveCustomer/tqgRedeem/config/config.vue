<template>
  <div class="sub_main_content">
    <base-marketing-config :checkBuyAll="checkBuyAll" :service="service" :marketingType="g_const.marketTemplateType.TQGREDEEM_P4P_SYS" :updateSidebar="getSaveCustomerSidebar">
...
import service from '../tqgRedeem.service'
export default {
  data() {
    return {
      showMoreBlock: false,
