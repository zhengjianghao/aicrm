      ...
      <div class="form-control form_control" style="padding-bottom: 0px">
        ...
        <div class="user_tablelist">
          <el-table :data="test.curPageData" max-height="775">
            ...
            <el-table-column min-width="150px" label="选择第一件宝贝">
              <template scope="scope">
                <div class="goodsName_row" v-if="scope.row.sub_title_1 != ''">
                  ...
                  <div class="pull-left introduce">
                    ...
                    <p class="sub_price">价格
                      <span class="des">￥{{scope.row.price_1}}</span>
                    </p>
                  </div>
                </div>
            ...
            <el-table-column min-width="100px">
              <template scope="scope">
                <div>+
                  <el-input v-model="scope.row.discount_money" style="width: 100px;margin-left: 20px">
            ...
            <el-table-column min-width="150px" label="优惠宝贝">
              <template scope="scope">
                <div class="goodsName_row" v-if="scope.row.sub_title_2 != ''">
                  ...
                  <div class="pull-left introduce">
                    ...
                    <p class="sub_price">价格
                      <span class="des">￥{{scope.row.price_2}}</span>
                    </p>
                  </div>
                </div>
                <div class="goodsName_row_choose" v-else>
