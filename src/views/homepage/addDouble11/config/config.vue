<template>
  <div>
    <base-marketing-config :service="service" :marketingType="g_const.marketTemplateType.ADDDOUBLE11INSTANT_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll" ref='baseMarketConf'>
...
import service from '../addDouble11.service'
