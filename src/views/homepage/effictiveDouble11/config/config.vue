<template>
  <div>
    <base-marketing-config ref='baseMarketConf' :service="service" :marketingType="g_const.marketTemplateType.EFFICTIVEDOUBLE11_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll">
...
import service from '../effictiveDouble11.service'
