...
<div class="chartWaper">
    <div id="chartFahuoId" class="warp">
        <el-row :gutter="8">
            <el-col :span="10">
                <div class="homepage_chartBlock">
                    <div>
                        <el-row :gutter="16">
                            <el-col :span="12">
                                <div class="homepage_chart_title iconfont icon-adduser">昨日新客户发货率
                                    <br/><span>282</span>人</div>
                            </el-col>
                            <el-col :span="12">
                                <div class="homepage_chart_title iconfont icon-user-black">昨日老客户发货率
                                    <br/><span>1,412</span>人</div>
                            </el-col>
                        </el-row>
                    </div>
                    <div>
                        <el-row>
                            <el-col :span="24">
                                <div id="fahuo-pieChart" class="pieChart"></div>
                            </el-col>
                        </el-row>
            ...
            <el-col :span="14">
                <div class="homepage_chartBlock">
                    <div id="fahuo-barChart" class="barChart"></div>
                </div>
            </el-col>
        </el-row>
    </div>
...
export default {
    data() {
        ...
        watch: {
            subState() {
                if (this.subState === this.global.activeCode.fahuo) {
        ...
        mounted() {
            this.pieChart = echarts.init(document.getElementById('fahuo-pieChart'));
            //pieChart.setOption(this.pieChartOption);
            this.barChart = echarts.init(document.getElementById('fahuo-barChart'));
