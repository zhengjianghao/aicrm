<template>
  <div>
    <base-marketing-config ref='baseMarketConf' :service="service" :marketingType="g_const.marketTemplateType.ALLBEFOREDOUBLE11_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll">
      <template slot="baseConfig" scope="props">
        ...
        <setting-list-double ref="settingcheck" :double11Import='importDouble11' doubleName='双11' :settingListData="props.conf.double_items"></setting-list-double>
        <div class="subTitle">
          结束提醒
        </div>
        <div class="form-control">
...
import service from '../allBeforeDouble11.service'
