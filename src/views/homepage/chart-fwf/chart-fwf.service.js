            ...
            tooltip: {
                ...
                formatter: function (array) {
                    ...
                    if (splitNumber == '3' || splitNumber == '6' || splitNumber == '12') {
                        tempNameOldAve = '服务费周平均值'
                    } else {
                        tempNameOldAve = '服务费月平均值'
                    }
                    var tempNameOld = '服务费'
                    var tempNumOld = 0
                    var tempNumAveOld = 0
                    tempNumOld = parseFloat(oldp[1]).toFixed(3)
                    tempNumAveOld = parseFloat(aveOldP[1]).toFixed(3)
