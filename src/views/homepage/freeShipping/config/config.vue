    ...
    <el-form :model="conf" :show-message="false" :rules="rules" ref="conf" class="demo-ruleForm">
      ...
      <div class="form-control form_control" style="padding-bottom: 0px">
        ...
        <div class="user_tablelist">
          <el-table :data="test.curPageData" max-height="775" style="width:100%">
            ...
            <el-table-column min-width="300" label="可享优惠">
              <template scope="scope">
                <div>
                  <el-row :gutter="16">
                    <el-col :span="5">
                      <el-checkbox v-model="scope.row.discount[0]">包邮</el-checkbox>
                    </el-col>
                    <el-col :span='3'>
                ...
                <div class="flag">
                  <el-row :gutter="16">
                    <el-col :span="5">
                      <el-checkbox v-model="scope.row.discount[1]">自动添加备注</el-checkbox>
                    </el-col>
                    <el-col :span='19'>
            ...
            <el-row :gutter="20" class="validRow">
              ...
              <el-col :span="19">
                ...
                <el-form-item prop="payment_start">
                  <el-tooltip class="item" effect="dark" :manual="true" :value="conf.payment_start_invalid" :disabled="payment_label == ''" :content="conf.payment_start_invalid_msg" placement="top">
                ...
                <el-form-item prop="payment_end">
                  <el-tooltip class="item" effect="dark" :manual="true" :disabled="payment_label == ''" :value="conf.payment_end_invalid" :content="conf.payment_end_invalid_msg" placement="top">
