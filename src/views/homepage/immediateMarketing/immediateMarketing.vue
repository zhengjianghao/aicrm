<template>
  <div>
    <marketing-header
      base="基于【拍下即时营销】模板"
      noSwitch='true'
      tip="设计理念：在新老买家下单的同时进行精准至潜需宝贝营销，促进本次就加购，提高客单价和转化率的同时还可以进一步提高复购几率（历史数据表明前一次买的越多的买家下次复购的几率越高）"
      remind="分成规则：公式=买家被营销之后72小时内拍下付款并最终交易成功的金额（扣除退款）×店铺对应类目服务费扣点；买家每确认一笔就扣除一笔服务费（确认交易成功后产生的售后退款不返还，订单时间以拍下时间为准）">
    </marketing-header>
    <div>
