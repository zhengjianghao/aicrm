<template>
  <div>
    <marketing-header tip="提醒：此项不建议与【拍下即时营销】同时开启，因为信息密度过大会影响买家体验 ^_^">
    </marketing-header>
    <div>
      <el-tabs @tab-click="activeSubCode" v-model="vm.activeName">
        ...
        <el-tab-pane :label="g_const.marketingResultTab[5].label" :name="g_const.marketingResultTab[5].name">
