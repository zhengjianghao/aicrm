<template>
  ...
  <base-marketing-config
    :service="service"
    :marketingType="g_const.marketTemplateType.PAYMENT_P4P_SYS"
      ...
      <div class="form-control form_control more_condition">
          <el-form-item  prop="status">
            <el-row :gutter="20">
              ...
              <el-col :span="21">
                <el-radio v-model="orderState" label="">拍下已付款</el-radio>
              </el-col>
            </el-row>
          </el-form-item>
          ...
          <el-form-item>
            <el-row :gutter="20">
                ...
                <el-col :span="21"><span>买家付款后 实时发送</span></el-col>
            </el-row>
          </el-form-item>
          <el-form-item>
              <el-row :gutter="20">
                <el-col :span="3"><p>信息发送时间段：</p></el-col>
                <el-col :span="21"><span>全天</span></el-col>
            </el-row>
          </el-form-item>
