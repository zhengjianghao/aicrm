<template>
  <div>
    <base-marketing-config :service="service" ref='baseMarketConf' :marketingType="g_const.marketTemplateType.EFFICTIVEDOUBLE12_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll">
...
import service from '../effictiveDouble12.service'
