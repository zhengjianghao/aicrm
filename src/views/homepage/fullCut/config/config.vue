<template>
  <div class="sub_main_content">
    <el-form :model="conf" :show-message="false" :rules="rules" ref="conf" class="demo-ruleForm">
      ...
      <div class="form-control form_control" style="padding-bottom: 0px">
        <el-form-item>
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <img style="height: 150px" src="../../../../assets/images/u4088.png" />
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
          <el-row :gutter="20">
            ...
            <el-col :span="9">
              <el-date-picker v-model="conf.deadline[0]" format="yyyy-MM-dd HH:mm" type="datetime" :editable="false" placeholder="选择时间范围">
              </el-date-picker>
              至
              <el-date-picker v-model="conf.deadline[1]" format="yyyy-MM-dd HH:mm" type="datetime" :editable="false" placeholder="无期限">
              </el-date-picker>
            </el-col>
            <el-col :span="12">
              <div class="title_show">{{conf.active_title}}</div>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <div class="user_tablelist">
          <el-table :data="test.curPageData" max-height="775">
            <el-table-column min-width="30px">
              <template scope='scope'>
                <div></div>
              </template>
            </el-table-column>
            <el-table-column min-width="150" label="需满足条件">
              <template scope="scope">
                <div class="">
                  <el-checkbox v-model="scope.row.condition[0]">满</el-checkbox>
                  <el-input v-model="scope.row.condition_money"></el-input> 元
                </div>
                <div class="">
                  <el-checkbox v-model="scope.row.condition[1]">满</el-checkbox>
                  <el-input v-model="scope.row.condition_goodsNum"></el-input> 件
                </div>
                <div class="">
                  <el-checkbox v-model="scope.row.condition[2]">满</el-checkbox>
                  <el-input v-model="scope.row.condition_goodsType"></el-input> 种类
                </div>
                <div class="">
                  <el-checkbox v-model="scope.row.condition[3]">满</el-checkbox>
                  <el-input v-model="scope.row.condition_buyTimes"></el-input> 次购买
                </div>
              </template>
            </el-table-column>
            <el-table-column min-width="300" label="可享优惠">
              <template scope="scope">
                <div>
                  <el-row :gutter="16">
                    <el-col :span="5">
                      <el-checkbox v-model="scope.row.discount[0]">价格优惠</el-checkbox>
                    </el-col>
                    <el-col :span="7">
                      <el-radio v-model="scope.row.discount_cut" label="">打
                        <el-input v-model="scope.row.discount_cut_discount" style="width: 100px">
                          <template slot="append">折</template>
                        </el-input>
                      </el-radio>
                    </el-col>
                    <el-col :span="7">
                      <el-radio v-model="scope.row.discount_cut" label="money">减
                        <el-input v-model="scope.row.discount_cut_money" style="width: 100px">
                          <template slot="append">元</template>
                        </el-input>
                      </el-radio>
                    </el-col>
                    <el-col :span="5">
                      <el-checkbox v-model="scope.row.discount_isMultiplication">享受倍增</el-checkbox>
                    </el-col>
                  </el-row>
                </div>
                <div>
                  <el-row :gutter="16">
                    <el-col :span="5">
                      <el-checkbox v-model="scope.row.discount[1]">送优惠券</el-checkbox>
                    </el-col>
                    <el-col :span='19'>
                      <el-select v-model="scope.row.discount_coupon">
                        <el-option v-for="item in g_const.marketingInterval" :label="item.name" :value="item.value" :key="item.value">
                        </el-option>
                      </el-select>
                      <a class="link link_underline">创建新优惠券</a>
                    </el-col>
                  </el-row>
                </div>
                <div>
                  <el-row :gutter="16">
                    <el-col :span="5">
                      <el-checkbox v-model="scope.row.discount[2]">包邮</el-checkbox>
                    </el-col>
                    <el-col :span='3'>
                      <el-radio v-model="scope.row.freeShipping" label=''>全国包邮</el-radio>
                    </el-col>
                    <el-col :span='16'>
                      <el-radio v-model="scope.row.freeShipping" label='part'>地区包邮</el-radio>
                    </el-col>
                  </el-row>
                </div>
                <div>
                  <el-row :gutter="16">
                    <el-col :span="5">
                      <el-checkbox v-model="scope.row.discount[3]">自动添加备注</el-checkbox>
                    </el-col>
                    <el-col :span='19'>
                      <div class="updateFlag">
                        <span class="flag_start">该备注旗子颜色</span>
                        <flags :checkedFlags="scope.row.seller_flag" :gift="true"></flags>
                      </div>
                    </el-col>
                  </el-row>
                </div>
            ...
            <el-table-column min-width="90px" label="操作">
              <template scope="scope">
                <span class="link_underline" @click="cancel(scope.$index)">
        ...
        <el-form-item>
          <el-row :gutter="20">
            ...
            <el-col :span="2">
              <el-radio v-model="conf.activety_goods" label="">单个宝贝</el-radio>
            </el-col>
            <el-col :span="2">
              <el-radio v-model="conf.activety_goods" label="part">部分宝贝</el-radio>
            </el-col>
            <el-col :span="17">
              <el-radio v-model="conf.activety_goods" label="all">全部宝贝</el-radio>
            </el-col>
          </el-row>
          <el-row :gutter="20">
        ...
        <el-form-item>
          <el-row :gutter="20">
            ...
            <el-col :span="6">
              <el-checkbox v-model="conf.limitBuy_every">每个宝贝限购</el-checkbox>
              <el-input v-model="conf.limitBuy_every_num" :disabled="!conf.limitBuy_every">
                <template slot="append">个</template>
              </el-input>
            </el-col>
            <el-col :span="15">
              <el-checkbox v-model="conf.limitBuy_selected">选中宝贝整体限购</el-checkbox>
      ...
      <div class="form-control more_condition">
        <el-form-item>
          <el-row :gutter="20">
            ...
            <el-col :span='21'>
              <span>您已选{{conf.gradeNum}}个会员</span>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="3"></el-col>
            <el-col :span="2">
              <el-radio v-model="conf.group_label" label="">全部会员</el-radio>
            </el-col>
            <el-col :span="8">
              <el-radio v-model="conf.group_label" label="AI">
                <AI></AI>智慧分组</el-radio>
              <el-popover ref="AIGroup" placement="bottom" width="200" :disabled="conf.group_label !== 'AI'" trigger="click">
                <el-tree :data="memberGroupTreeData['AI引擎流转分组']" show-checkbox node-key="id" :default-checked-keys="conf.gourp_ai_id" :accordion="true" :props="defaultProps" @check-change="AICheckGroupChange">
                </el-tree>
              </el-popover>
              <el-input placeholder="请选择分组" v-popover:AIGroup class="linkInput" readonly v-model="AISelGroup" :disabled="conf.group_label !== 'AI'">
            ...
            <el-col :span="11">
              <el-checkbox v-model="conf.isPart_goods">AI根据选定宝贝潜需智慧推荐</el-checkbox>
            </el-col>
          </el-row>
          <el-row :gutter="20" style="margin-top:5px">
            <el-col :span="3"></el-col>
            <el-col :span="2">
              <el-radio v-model="conf.group_label" label="all">全网会员</el-radio>
            </el-col>
            <el-col :span="6">
              <el-radio v-model="conf.group_label" label="grade">会员等级</el-radio>
              <el-popover ref="gradeGroup" placement="bottom" width="200" :disabled="conf.group_label !== 'grade'" trigger="click">
                <el-tree :data="memberGroupTreeData['会员等级']" show-checkbox node-key="id" :default-checked-keys="conf.gourp_grade_id" :accordion="true" :props="defaultProps" @check-change="tagCheckGroupChange">
                </el-tree>
              </el-popover>
              <el-input placeholder="请选择分组" v-popover:gradeGroup class="linkInput" readonly v-model="gradeSelGroup" :disabled="conf.group_label !== 'grade'">
                <template slot="append">
                  <span class="iconfont icon-treeMenu"></span>
                </template>
              </el-input>
            ...
            <el-col :span="13">
              <el-radio v-model="conf.group_label" label="custom">自建营销分组</el-radio>
              <el-popover ref="customGroup" placement="bottom" width="200" :disabled="conf.group_label !== 'custom'" trigger="click">
                <el-tree :data="memberGroupTreeData['自建营销分组']" show-checkbox node-key="id" :default-checked-keys="conf.gourp_custom_id" :accordion="true" :props="defaultProps" @check-change="VIPCheckGroupChange">
                </el-tree>
              </el-popover>
              <el-input placeholder="请选择分组" v-popover:customGroup class="linkInput" readonly v-model="customSelGroup" :disabled="conf.group_label !== 'custom'">
                <template slot="append">
                  <span class="iconfont icon-treeMenu"></span>
                </template>
              </el-input>
        ...
        <div class="form-control form_control more-content" v-show="showMoreBlock">
          <el-form-item prop="created">
            <el-row :gutter="20">
              ...
              <el-col :span="2">
                <el-radio v-model="conf.created_label" label="">不限制</el-radio>
              </el-col>
              <el-col :span="2">
                <el-radio v-model="conf.created_label" label="1month">最近一个月</el-radio>
              </el-col>
              <el-col :span="2">
                <el-radio v-model="conf.created_label" label="3month">最近三个月</el-radio>
              </el-col>
              <el-col :span="15">
                <el-radio v-model="conf.created_label" label="custom">自定义</el-radio>
                <el-date-picker v-model="conf.created" style="width: 190px;" :disabled="conf.created_label !== 'custom'" type="daterange" :editable="false" placeholder="选择时间范围">
                </el-date-picker>
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item prop="trade_from">
            <el-row :gutter="20">
              ...
              <el-col :span="2">
                <el-radio v-model="conf.trade_from" label="">全部</el-radio>
              </el-col>
              <el-col :span="2">
                <el-radio v-model="conf.trade_from" label="PC">PC订单</el-radio>
              </el-col>
              <el-col :span="14">
                <el-radio v-model="conf.trade_from" label="phone">手机订单</el-radio>
              </el-col>
            </el-row>
          </el-form-item>
          ...
          <el-form-item>
            <el-row :gutter="20" class="validRow">
              ...
              <el-col :span="2">
                <el-radio label="" v-model="payment_label">不限制</el-radio>
              </el-col>
              <el-col :span="19">
                <el-radio label="custom" v-model="payment_label">价格在</el-radio>
                <el-form-item prop="payment_start">
                  <el-tooltip class="item" effect="dark" :manual="true" :disabled="payment_label == ''" :value="conf.payment_start_invalid" :content="conf.payment_start_invalid_msg" placement="top">
                    <el-input v-model="conf.payment_start" style="width:100px" :disabled="payment_label !== 'custom'">
                      <template slot="append">元</template>
                    </el-input>
                  </el-tooltip>
                  至
                ...
                <el-form-item prop="payment_end">
                  <el-tooltip class="item" effect="dark" :disabled="payment_label == ''" :manual="true" :value="conf.payment_end_invalid" :content="conf.payment_end_invalid_msg" placement="top">
                    <el-input v-model="conf.payment_end" style="width:100px" :disabled="payment_label !== 'custom'">
                      <template slot="append">元</template>
                    </el-input>
                  </el-tooltip>
                </el-form-item>
            ...
            <el-row :gutter="20" class="validRow">
              ...
              <el-col :span="21">
                <el-form-item prop="buys_start">
                  <el-tooltip class="item" effect="dark" :manual="true" :value="conf.buys_start_invalid" :content="conf.buys_start_invalid_msg" placement="top">
                    <el-input v-model="conf.buys_start" placeholder="不限" style="width:100px"></el-input>
                  </el-tooltip> 至
                </el-form-item>
                <el-form-item prop="buys_end">
                  <el-tooltip class="item" effect="dark" :manual="true" :value="conf.buys_end_invalid" :content="conf.buys_end_invalid_msg" placement="top">
          ...
          <el-form-item prop="pay_time">
            <el-row :gutter="20">
              ...
              <el-col :span="21">
                每天
                <el-time-select v-model="conf.pay_time_start" :editable="false" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00'
                        }">
                ...
                至
                <el-time-select v-model="conf.pay_time_end" :editable="false" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00',
                        }">
          ...
          <el-form-item prop="consign_time">
            <el-row :gutter="20">
              ...
              <el-col :span="21">
                每天
                <el-time-select v-model="conf.consign_time_start" :editable="false" is-range range-separator="至" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00'
                        }">
                ...
                至
                <el-time-select v-model="conf.consign_time_end" :editable="false" is-range range-separator="至" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00',
                        }">
          ...
          <el-form-item prop="sign_time">
            <el-row :gutter="20">
              ...
              <el-col :span="21">
                每天
                <el-time-select v-model="conf.sign_time_start" :editable="false" is-range range-separator="至" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00'
                        }">
                ...
                至
                <el-time-select v-model="conf.sign_time_end" :editable="false" is-range range-separator="至" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00',
                        }">
          ...
          <el-form-item prop="end_time">
            <el-row :gutter="20">
              ...
              <el-col :span="21">
                每天
                <el-time-select v-model="conf.end_time_start" :editable="false" is-range range-separator="至" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00'
                        }">
                ...
                至
                <el-time-select v-model="conf.end_time_end" :editable="false" is-range range-separator="至" placeholder="不限" :picker-options="{
                        start: '00:00',
                        step: '00:15',
                        end: '24:00',
                        }">
          ...
          <el-form-item>
            <el-row :gutter="20">
              ...
              <el-col :span="2">
                <el-radio v-model="conf.buyer_message" label="">不限制</el-radio>
              </el-col>
              <el-col :span="3">
                <el-radio v-model="conf.buyer_message" label="messaged">有留言发送</el-radio>
              </el-col>
              <el-col :span="16">
                <el-radio v-model="conf.buyer_message" label="nomessaged">无留言发送</el-radio>
              </el-col>
            </el-row>
          </el-form-item>
      ...
      <div class="form-control">
        <el-form-item style="padding-top:20px">
          <el-row :gutter="20">
            ...
            <el-col :span="21">
              <el-checkbox v-model="conf.reminder_label" label="">活动结束前</el-checkbox>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="21">
              <el-select v-model="conf.reminder.qianniu">
                <el-option v-for="item in value1" :label="item.name" :value="item.value" :key="item.value">
                </el-option>
              </el-select>
            </el-col>
          </el-row>
      ...
      <div class="subTitle">
        推送配置
        <el-switch v-model="push_switch" on-text="关" off-text="开">
        </el-switch>
      </div>
      <div class="form-control form_control">
        <el-form-item prop="send_time">
          <el-row :gutter="20">
            ...
            <el-col :span="5">
              <el-radio v-model="conf.send_time_label" label="">
                <AI></AI>智慧逐个推算</el-radio>
            </el-col>
            <el-col :span="16">
              <el-radio v-model="conf.send_time_label" label="custom">定时发送</el-radio>
              <el-date-picker :disabled="conf.send_time_label === ''" v-model="conf.send_time" :editable="false" type="datetime" placeholder="选择日期时间">
              </el-date-picker>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              ...
              <el-time-select :disabled="!conf.exclude_time_label" v-model="conf.exclued_time_start" :editable="false" placeholder="不限" :picker-options="{
                          start: '00:00',
                          step: '00:15',
                          end: '24:00'
                          }">
              ...
              至
              <el-time-select :disabled="!conf.exclude_time_label" v-model="conf.exclued_time_end" :editable="false" placeholder="不限" :picker-options="{
                          start: '00:00',
                          step: '00:15',
                          end: '24:00',
                          }">
            ...
            <el-col :span="13">
              <el-checkbox v-model="conf.ahead_time_label" :disabled="conf.send_time_label === 'custom'">在不发送时间内的信息自动提前发送</el-checkbox>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item>
          <el-row :gutter="20">
            ...
            <el-col :span="2">
              <el-radio v-model="conf.send_type" label="sms">仅短信</el-radio>
            </el-col>
            <el-col :span="2">
              <el-radio v-model="conf.send_type" label="千牛">仅千牛</el-radio>
            </el-col>
            <el-col :span="2">
              <el-radio v-model="conf.send_type" label="all">短信+千牛同时</el-radio>
            </el-col>
            <el-col :span="15">
              <el-radio v-model="conf.send_type" label="AI">
                <AI></AI>智慧管理</el-radio>
            </el-col>
...
export default {
    ...
    return {
      ...
      test: {
        curPageData: [{
          ...
          condition_goodsType: '',
          condition_buyTimes: '',
          discount: [true, false, true, false],
          discount_cut: '',
          discount_cut_discount: '',
          discount_cut_money: '',
          discount_isMultiplication: true,
          discount_coupon: '',
          freeShipping: '',
          seller_flag: ''
        }],
  ...
  methods: {
    ...
    cancel(index) {
      if (this.test.curPageData.length > 1) {
        this.test.curPageData.splice(index, 1)
      } else {
        this.test.curPageData = [{
          condition: [false, false, true, true],
          condition_money: '',
          condition_goodsNum: '',
          condition_goodsType: '',
    ...
    addDiscount() {
      ...
      this.test.curPageData.push(add)
    }
  },
  components: {
    flags,
