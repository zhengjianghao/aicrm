<template>
  <div>
    <base-marketing-config :service="service" ref='baseMarketConf' :marketingType="g_const.marketTemplateType.CUSTOMIZEDDOUBLE12_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll">
...
import service from '../customizedDouble12.service'
