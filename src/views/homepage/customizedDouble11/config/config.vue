<template>
  <div>
    <base-marketing-config ref='baseMarketConf' :service="service" :marketingType="g_const.marketTemplateType.CUSTOMIZEDDOUBLE11_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll">
...
import service from '../customizedDouble11.service'
