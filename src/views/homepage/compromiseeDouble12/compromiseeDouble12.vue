<template>
  <div>
    <marketing-header base="基于【双12折中型】模板" tip="设计理念：在效果最大化和效率最大化之间作一定取舍" remind="方案：主要逻辑取最近一年有过购物的，按照买家营销的成功率排列越高的越晚发，1-10号相对均匀分布，特别考虑2-3、9-10日双12前的这周末，11号作巩固发过的再重发一次">
    </marketing-header>
    <div>
