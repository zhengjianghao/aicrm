<template>
  <div>
    <base-marketing-config :service="service" ref='baseMarketConf' :marketingType="g_const.marketTemplateType.COMPROMISEEDOUBLE12_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll">
      <template slot="baseConfig" scope="props">
        <calendar-date :calData='props.conf.cal_num' calType="double12"></calendar-date>
        <div>
        ...
        <lazy-render time="1500" minHeight="110px" loadingTime="1500">
          <add-stair12 doubleName='双12'ref="addStair" :stairDate='props.conf.stairs'></add-stair12>
        </lazy-render>
        <div class="subTitle">
          推送配置
        </div>
        ...
        <setting-list-double ref="settingcheck" doubleName='双12' :double11Import='importDouble11' :settingListData="props.conf.double_items"></setting-list-double>
        <div class="subTitle">
          结束提醒
        </div>
        <div class="form-control">
...
import service from '../compromiseeDouble12.service'
