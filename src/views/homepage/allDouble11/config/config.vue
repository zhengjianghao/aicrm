<template>
  <div>
    <base-marketing-config :service="service" ref='baseMarketConf' :marketingType="g_const.marketTemplateType.ALLDOUBLE11_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll">
...
import service from '../allDouble11.service'
