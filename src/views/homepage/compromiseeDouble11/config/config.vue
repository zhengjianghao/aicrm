<template>
  <div>
    <base-marketing-config :service="service" :marketingType="g_const.marketTemplateType.COMPROMISEEDOUBLE11_P4P_SYS" :updateSidebar="getHomePageSidebar" :checkBuyAll="checkAll" ref='baseMarketConf'>
...
import service from '../compromiseeDouble11.service'
