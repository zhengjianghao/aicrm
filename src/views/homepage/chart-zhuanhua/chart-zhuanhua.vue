...
<template>
    <div class="chartWaper">
        <div id="chartZhuahuaId" class="warp">
            <el-row :gutter="8">
                <el-col :span="10">
                    <div class="homepage_chartBlock">
                        <div>
                            <el-row :gutter="16">
                                <el-col :span="12">
                                    <div class="homepage_chart_title iconfont icon-adduser">昨日新客户付款转化率
                                        <br/>
                                        <span>282</span>人</div>
                                </el-col>
                                <el-col :span="12">
                                    <div class="homepage_chart_title iconfont icon-user-black">昨日老客户付款转化率
                                        <br/>
...
export default {
    ...
    watch: {
        subState() {
            if (this.subState === this.global.activeCode.zhuanhua) {
