...
<template>
    <div class="chartWaper">
        <div id="chartHuikuanId" class="warp">
            <el-row :gutter="8">
                <el-col :span="10">
                    <div class="homepage_chartBlock">
                        <div>
                            <el-row :gutter="16">
                                <el-col :span="12">
                                    <div class="homepage_chart_title iconfont icon-adduser">昨日新客户回款率
                                        <br/>
                                        <span>282</span>人</div>
                                </el-col>
                                <el-col :span="12">
                                    <div class="homepage_chart_title iconfont icon-user-black">昨日老客户回款率
                                        <br/>
                        ...
                        <div>
                            <el-row>
                                <el-col :span="24">
                                    <div class="pieChart" id="huikuan-pieChart"></div>
                                </el-col>
                            </el-row>
                ...
                <el-col :span="14">
                    <div class="homepage_chartBlock">
                        <div class="barChart" id="huikuan-barChart"></div>
                    </div>
                </el-col>
            </el-row>
        </div>
...
export default {
    ...
    watch: {
        subState() {
            if (this.subState === this.global.activeCode.huikuan) {
    ...
    mounted() {
        this.pieChart = echarts.init(document.getElementById('huikuan-pieChart'));
        //pieChart.setOption(this.pieChartOption);
        this.barChart = echarts.init(document.getElementById('huikuan-barChart'));
