<template>
  <div>
    <marketing-header base="基于【跟随潜需营销】模板" tip="设计理念：对买家的整个生命周期实施跟踪式不间断营销，始终在买家下一次购物恰当时间点推送潜需的宝贝，保持活跃度，提高复购率">
    </marketing-header>
    <div>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.getActiveMenuCode(g_const.activeMenuCodes.firstBuy)
