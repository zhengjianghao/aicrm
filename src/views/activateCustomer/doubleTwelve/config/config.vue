<template>
  <div class="sub_main_content">
    <base-marketing-config :checkBuyAll="checkBuyAll" :service="service" :marketingType="g_const.marketTemplateType.DOUBLETWELVE_P4P_SYS" :updateSidebar="getActivateCustomerSidebar">
      <template slot="baseConfig" scope="props">
        ...
        <div class="form-control">
          <config-sendtime-N :sendDate='props.conf.send_date' :beforeWord="'双12开始日期提前'" :sendTimeLabel='props.conf.send_time_label' :sendTime='props.conf.send_time' :excludeTimeLabel='props.conf.exclude_time_label' :elcludeTime="props.conf.exclude_time" :sendWord="''" :aheadTimeLabel="props.conf.ahead_time_label">
          </config-sendtime-N>
...
import service from '../doubleTwelve.service'
export default {
  data() {
    return {
      showMoreBlock: false,
