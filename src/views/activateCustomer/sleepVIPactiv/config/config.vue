<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :checkBuyAll="checkBuyAll" :marketingType="g_const.marketTemplateType.SLEEPVIPACTIV_P4P_SYS" :updateSidebar="getActivateCustomerSidebar">
      <template slot="baseConfig" scope="props">
        ...
        <div class="form-control form_control" style="padding-bottom: 0px">
          ...
          <el-form-item>
            <config-target-member :groupLabel="props.conf.group_label" :curGroupIds="props.conf.curGroupIds" :isItemLabel="props.conf.is_item_label" :OnlyNew='props.conf.only_new_label' :isSelectGoods="getIsSelectGoods">
...
import service from '../sleepVIPactiv.service'
