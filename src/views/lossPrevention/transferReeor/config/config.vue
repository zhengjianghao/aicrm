<template>
  <div class="sub_main_content">
    ...
    :service="service"
    :marketingType="g_const.marketTemplateType.TRANSFERREEOE_P4P_SYS"
          ...
          <div class="form-control form_control" style="padding-bottom: 0px">
              <el-form-item>
                <el-row :gutter="20">
                  ...
                  <el-col :span='21'>快递运送中出现异常时触发</el-col>
                </el-row>
              </el-form-item>
              <el-form-item>
                <config-deadline
              ...
              <el-form-item>
                <el-row :gutter='20'>
                  <el-col :span="3"><p>流转异常：</p></el-col>
                  <el-col :span="21">
                    <el-checkbox-group v-model="props.conf.abnormal_flow">
                      <el-checkbox v-for="item in abnormalFlow" :key='item.value' :label="item.value" :value="item.value">{{item.name}}</el-checkbox>
                    </el-checkbox-group>
                  </el-col>
                </el-row>
              </el-form-item>
...
<script type="text/ecmascript-6" scoped>
  ...
  import service from '../transferReeor.service'
  export default {
    data() {
      return {
       showMoreBlock: false,
