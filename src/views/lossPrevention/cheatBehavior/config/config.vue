<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :marketingType="g_const.marketTemplateType.CHEATBEHAVIOR_P4P_SYS" :updateSidebar="getLossPreventionSidebar">
      ...
      <template slot="baseConfig" scope="props">
          ...
          <el-form-item prop="check_keywords">
            <el-row :gutter="20" v-show="props.conf.check_keywords!=''">
              ...
              <el-col :span="21" class="keyWord_height">
                <el-tag style="margin-right: 5px;" :key="tag" v-for="tag in props.conf.check_keywords" :closable="true" :close-transition="false" @close="handleClose(tag,props.conf.check_keywords)">
                  {{tag}}
                </el-tag>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              ...
              <el-col :span="21">
                ...
                <a @click="addTag(props.conf.check_keywords)" class="link_underline" style="margin-left: 15px;">添加</a>
              </el-col>
            </el-row>
          </el-form-item>
        ...
        <msg-edit-temp msgType='messageTemplate'  :allLine='jurisdictionData.allShow ? allLine : allLine2' :msgContent="props.conf.message">
        </msg-edit-temp>
        <div class="subTitle">
          客服提醒
        </div>
        <div>
          <el-form-item>
            ...
            <msg-edit-temp-t :sendTypeUser='props.conf.send_type_user' :msgContent='props.conf.send_message_user' :sendMobile='props.conf.send_mobile_user' :allLine='jurisdictionData.allShow ? allLine : allLine2'></msg-edit-temp-t>
          </el-form-item>
        </div>
      </template>
...
import service from '../cheatBehavior.service'
export default {
  data() {
    return {
      showMoreBlock: false,
