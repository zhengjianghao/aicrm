<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :marketingType="g_const.marketTemplateType.DISPLEASURE_P4P_SYS" :updateSidebar="getLossPreventionSidebar">
...
import service from '../badAtti.service'
export default {
  data() {
    return {
      showMoreBlock: false,
