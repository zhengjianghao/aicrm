<template>
  <div class="sub_main_content">
    ...
    :service="service"
    :marketingType="g_const.marketTemplateType.COMMENTREMIND_P4P_SYS"
                ...
                <el-form-item>
                  <el-row :gutter="20">
                      ...
                      <el-col :span="5">
                        ...
                        <el-tooltip popper-class='tool_notes' content='注释：魔方墙AI引擎基于最近3个月买家初评行为分析，触发时间为买家初评时间间隔均值的，每月更新动态跟随店铺发展' placement="top-start">
...
<script type="text/ecmascript-6" scoped>
  ...
  import service from '../commentRemind.service'
  export default {
    data() {
      return {
        showMoreBlock: false,
