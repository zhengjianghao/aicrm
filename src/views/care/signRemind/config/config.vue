<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :marketingType="g_const.marketTemplateType.SIGNREMIND_P4P_SYS" :updateSidebar="getCareSidebar">
...
import service from '../signRemind.service'
export default {
  data() {
    return {
      showMoreBlock: false,
