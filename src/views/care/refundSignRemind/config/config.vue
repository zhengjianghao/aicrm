<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :marketingType="g_const.marketTemplateType.REFUNDSIGNREMIND_P4P_SYS" :updateSidebar="getCareSidebar">
...
import service from '../refundSignRemind.service'
export default {
  data() {
    return {
      showMoreBlock: false,
