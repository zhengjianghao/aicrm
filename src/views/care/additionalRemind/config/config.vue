<template>
  <div class="sub_main_content">
    ...
    :service="service"
    :marketingType="g_const.marketTemplateType.ADDITIONALREMIND_P4P_SYS"
                ...
                <el-form-item>
                  <el-row :gutter="20">
                      ...
                      <el-col :span="5">
                        ...
                        <el-tooltip popper-class='tool_notes' content='注释：魔方墙AI引擎基于最近3个月买家追评行为分析，触发时间为买家追评时间间隔均值的，每月更新动态跟随店铺发展' placement="top-start">
                          <i class="iconfont icon-help1 toolGanTanHao"></i>
                        </el-tooltip>
                      </el-col>
                      <el-col :span="16"><el-radio v-model="props.conf.trigger_node_label" label='custom'>买家初评后</el-radio>
                        <el-select
...
<script type="text/ecmascript-6" scoped>
  ...
  import service from '../additionalRemind.service'
  export default {
    data() {
      return {
        showMoreBlock: false,
