<template>
  <div class="sub_main_content">
    <base-marketing-config :service="service" :marketingType="g_const.marketTemplateType.SENDREMIND_P4P_SYS" :updateSidebar="getCareSidebar">
...
import service from '../arriveMy.service'
export default {
  data() {
    return {
      showMoreBlock: false,
