<template>
  <div class="sub_main_content">
    ...
    :service="service"
    :marketingType="g_const.marketTemplateType.DELIVERREMIND_P4P_SYS"
            ...
            <div class="form-control form_control" style="padding-bottom: 0px">
                ...
                <el-form-item>
                  <el-row :gutter="20">
                      ...
                      <el-col :span="13"><el-radio v-model="props.conf.trigger_node_label" label='custom'>商家发货后</el-radio>
                        <el-select
...
<script type="text/ecmascript-6" scoped>
  ...
  import service from '../deliverRemind.service'
  export default {
    data() {
      return {
        showMoreBlock: false,
