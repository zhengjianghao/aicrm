<template>
  <div class="sub_main_content">
    ...
    :service="service"
    :marketingType="g_const.marketTemplateType.REFUSERETURNREFUND_P4P_SYS"
            ...
            <div class="form-control form_control" style="padding-bottom: 0px">
                ...
                <el-form-item>
                  <el-row :gutter="20">
                      ...
                      <el-col :span="13">商家拒绝退货退款申请后
                        <el-select v-model="props.conf.trigger_node">
                          <el-option
                          v-for="item in g_const.urgeTime2"
                          :label="item.name"
                          :value="item.value"
                          :key="item.value"
                          >
...
<script type="text/ecmascript-6" scoped>
  ...
  import service from '../refuseReturnRefund.service'
  export default {
    data() {
      return {
        showMoreBlock: false,
